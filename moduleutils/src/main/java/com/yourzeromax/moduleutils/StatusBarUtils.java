...
public class StatusBarUtils {
    ...
    private static final int FAKE_TRANSLUCENT_VIEW_ID = 0;
        ...
        public static void setDefaultStatusBarColor(Activity activity) {
            if (setLightStatusBarMode(activity, true)) {
                setColor(activity, activity.getResources().getColor(R.color.appbar_bg_color), 0);
            } else {
                setColor(activity, activity.getResources().getColor(R.color.appbar_bg_color));
            }
        }

        public static boolean setLightStatusBarMode(Activity activity, boolean light) {
            boolean succeed = false;
            if (FlymeSetStatusBarLightMode(activity.getWindow(), !light) || MIUISetStatusBarLightMode(activity.getWindow(), light)) {
                succeed = true;
            }
        ...
        public static int immersive(Activity activity) {
            View decorView = activity.getWindow().getDecorView();
            int ret = decorView.getSystemUiVisibility();
        ...
        public static void setSystemUiVisibility(Activity activity, int systemUiVisibility) {
            View decorView = activity.getWindow().getDecorView();
        ...
        public static void setTransparentForWindow(Window window) {
        ...
        /**
         * 为 fragment_game_data 头部是 ImageView 的设置状态栏透明
         *
         * @param activity       fragment_game_data 对应的 activity
         * @param needOffsetView 需要向下偏移的 View
         */
